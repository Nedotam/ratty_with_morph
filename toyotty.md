## About the fork
Fork [orhun/ratty](https://github.com/orhun/ratty) into `Nedotam/toyotty` — a cursor-focused terminal emulator with morph-mod squish/stretch animation and all upstream features intact.
